...
public:
    ...
    virtual SnapshotMeta& get_snapshot_meta() = 0; 
    virtual SnapshotWriter* get_snapshot_writer() = 0; 
};
...
public:
    ...
    BRAFT_MOCK int on_snapshot_save_with_meta(SaveSnapshotClosure* done);
...
friend class IteratorImpl;
    ...
    void do_snapshot_save_with_meta(SaveSnapshotClosure* done);
